...
var employee_login_check={
 
getAllemployee:function(callback){
return db.query("Select * from user_tbl where designation='employee'",callback); 
},

 getemployeeByuser_Id:function(id,callback){
return db.query("select * from user_tbl where email_id=? AND designation='employee'",[id],callback);
 }
...
//  }
 ...
 module.exports=employee_login_check;